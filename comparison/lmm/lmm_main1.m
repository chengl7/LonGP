...
formulaArr = {'y ~ 1 + (1|id)',...
    'y ~ age^2 + (age|id)',...
    'y ~ dise^2 + (1|id)',...
    'y ~ age^2 + dise^2 + (age|id)',...
    'y ~ loc + (1|id)',...
    'y ~ age^2 + loc*age + (age | id)',...
    'y ~ dise^2 + loc + (1|id)',...
    'y ~  age^2 + dise^2 + loc*age + (age | id)',...
    'y ~ gen + (1|id)',...
    'y ~ age^2 + gen*age + (age | id)',...
    'y ~ dise^2 + gen + (1|id)',...
    'y ~ age^2 + dise^2 + gen*age + (age | id)',...
    'y ~ loc + gen + (1|id)',...
    'y ~ age^2 + loc*age + gen*age + (age | id)',...
    'y ~ dise^2 + loc + gen + (1|id)',...
    'y ~ age^2 + dise^2 + loc*age + gen*age + (age | id)',...
    'y ~ group + (1|id)',...
    'y ~ age^2 + group*age + (age | id)',...
    'y ~ dise^2 + group + (1|id)',...
    'y ~ age^2 + dise^2 + group*age + (age | id)',...
    'y ~ loc + group + (1|id)',...
    'y ~ age^2 + loc*age + group*age + (age | id)',...
    'y ~ dise^2 + loc + group + (1|id)',...
    'y ~ age^2 + dise^2 + loc*age + group*age + (age | id)',...
    'y ~ gen + group + (1|id)',...
    'y ~ age^2 + gen*age + group*age + (age | id)',...
    'y ~ dise^2 + gen + group + (1|id)',...
    'y ~ age^2 + dise^2 + gen*age + group*age + (age | id)',...
    'y ~ loc + gen + group + (1|id)',...
    'y ~ age^2 + loc*age + gen*age + group*age + (age | id)',...
    'y ~ dise^2 + loc + gen + group + (1|id)',...
    'y ~ age^2 + dise^2 + loc*age + gen*age + group*age + (age | id)',...
    };
